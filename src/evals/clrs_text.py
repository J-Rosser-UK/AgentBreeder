...
class EvaluateCLRS(InspectBase):
    ...
    def _record_to_sample(self, record: dict[str, Any]) -> Sample:
        ...
        task_prompt = dedent(
            ...
            ### Instructions:
            Analyze the initial trace using the {parsed_question['algo_name']} algorithm and provide the sequence of states (trace) in the expected output format as the array is being sorted.
            """
        ).strip()
