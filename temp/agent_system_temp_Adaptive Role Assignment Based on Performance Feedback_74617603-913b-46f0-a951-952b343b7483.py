...
class AgentSystem:
    ...
    def forward(self, task: str) -> str:
        ...
        # Setup meeting
        meeting = self.Meeting(meeting_name="adaptive_role_assignment_meeting")
        ...
        routing_output = routing_agent.forward(response_format={
            "role_assignments": "JSON object with agent roles"
        })
        
        # Ensure routing_output is a dictionary
        try:
            role_assignments = json.loads(routing_output)
        except (json.JSONDecodeError, TypeError):
            return "Error: Unable to decode role assignments."
        ...
        return "No valid agent assigned to solve the task."
